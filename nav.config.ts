...
const c: IConfig = {
  // [必填], 请填写您的仓库地址
  gitRepoUrl: 'https://github.com/zwtdyhm/nav',
  ...
  // 您的网站地址，有利于SEO
  homeUrl: 'https://zwtdyhm.github.io/nav',

  // 网站标题
  title: '导航 - 精选实用导航网站',

  // 网站描述
  description: '导航 - 精选实用导航网站',
  ...
  // Light 主题配置
  lightThemeConfig: {
    // https://zwtdyhm.github.io/nav/#/light?q=grabient
    backgroundLinear: [
  ...
  simThemeConfig: {
    // 海报图
    posterImageUrls: [
      'https://raw.sevencdn.com/zwtdyhm/nav/image/sim-wallpaper.jpg'
    ],
